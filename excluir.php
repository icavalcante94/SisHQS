...
?>	
	...
	<p />
	<p />
    <form action="exclucao.php" method="post">
     <fieldset>
      <legend>Dados para exclução</legend> 
      <table border="0" width="100%">
	    <tr>	
		    <td>Código:</td><td><input type="text" name="codigo" placeholder="Código para excluir..." size="50"></td>
		</tr>	
		<tr>
		<td></td>
		</tr>
